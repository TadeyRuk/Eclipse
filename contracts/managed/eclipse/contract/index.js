...
export class Contract {
  ...
  constructor(...args_0) {
      ...
      distribute: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('distribute',
                                     ...
                                     'eclipse.compact line 55 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
    ...
    this.impureCircuits = { distribute: this.circuits.distribute };
    this.provableCircuits = { distribute: this.circuits.distribute };
  }
  initialState(...args_0) {
    if (args_0.length !== 3) {
    ...
    const total_0 = args_0[1];
    const recipientsIn_0 = args_0[2];
    ...
    if (!(typeof(total_0) === 'bigint' && total_0 >= 0n && total_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'eclipse.compact line 18 char 1',
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(0n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(total_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _addAmount_0(acc_0, x_0) {
    return ((t1) => {
             if (t1 > 18446744073709551615n) {
               throw new __compactRuntime.CompactError('eclipse.compact line 25 char 10: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
             }
             return t1;
           })(acc_0 + x_0);
  }
  ...
  _assertLifecycleFunded_0(context, partialProofData) {
  ...
  _assertPadding_0(amounts_0, recipientSlots_0) {
    ...
    this._folder_1(((t_0, i_0) =>
                    {
                      if (this._equal_0(recipientSlots_0[i_0], zeroPk_0)) {
                        __compactRuntime.assert(this._equal_1(amounts_0[i_0], 0n),
  ...
  _distribute_0(context, partialProofData, amounts_0, salts_0) {
    this._assertLifecycleFunded_0(context, partialProofData);
    ...
    __compactRuntime.assert(this._equal_2(total_0,
