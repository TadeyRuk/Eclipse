      ...
      createPayroll: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('createPayroll',
                                     ...
                                     'eclipse.compact line 57 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      fund: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('fund',
                                     'argument 1 (as invoked from Typescript)',
                                     'eclipse.compact line 68 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      distribute: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('distribute',
                                     'argument 1 (as invoked from Typescript)',
                                     'eclipse.compact line 74 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  _addAmount_0(acc_0, x_0) {
    return ((t1) => {
             if (t1 > 18446744073709551615n) {
               throw new __compactRuntime.CompactError('eclipse.compact line 21 char 10: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
             }
             return t1;
           })(acc_0 + x_0);
  }
